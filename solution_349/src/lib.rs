/// # [349. Intersection of Two Arrays](https://leetcode.com/problems/intersection-of-two-arrays/description/?envType=daily-question&envId=2024-03-10)
///
...
impl Solution {
    pub fn intersection(nums1: Vec<i32>, nums2: Vec<i32>) -> Vec<i32> {
        ...
        set1.into_iter().fold(Vec::new(), |mut vec, x| {
            if set2.contains(&x) {
                vec.push(x);
            }
