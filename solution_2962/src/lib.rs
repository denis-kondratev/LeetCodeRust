...
/// You are given an integer array `nums` and a positive integer `k`. Return the number
/// of subarrays where the maximum element of `nums` appears at least `k` times in that subarray.
